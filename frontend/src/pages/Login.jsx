    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-500 to-indigo-600 flex items-center justify-center py-6 px-3 sm:py-12 sm:px-4">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h1 className="text-4xl sm:text-5xl font-bold text-white mb-3">Academy</h1>
          <p className="text-blue-100 text-base sm:text-lg">Welcome back to your learning platform</p>
        </div>
